...
def convolution(img, filter_mask):
    ...
    :return: Convoluted image after applying Prewitt's operator
    """
...
def get_hog_feature(img, filename):
    """
    Function that computes gradient magnitude, gradient angle, HOG feature for both training and test images
